...
The above context is drawn from the user's own saved data inside Sovereign OS. Use it naturally when relevant. You may reference it with phrases like "based on your saved notes…", "your planner shows…", "according to your vision…", "your content pipeline shows…", or "based on your relationship notes…". Do not mention localStorage, internal key names, or technical implementation details. Do not fabricate details beyond what is explicitly provided above.`;
}
