  ...
  return (
    <div className="max-w-3xl mx-auto py-10 px-4">
      ...
      <section className="mb-8">
        ...
        <MigrationAssistant />
        <p className="text-[10px] text-white/20 mt-2 px-1">
          Requires authentication. localStorage is never modified. All upserts use
          the existing item ID — safe to run multiple times.
        </p>
      </section>
      ...
      <section className="mb-8">
        ...
        <SupabaseRestore />
        <p className="text-[10px] text-white/20 mt-2 px-1">
          Requires authentication. A backup of the current module is downloaded before
          any write. localStorage remains the source of truth — Supabase data is never
          modified or deleted.
        </p>
      </section>
